...
func Example_withServiceAccountKeyFileCredentials_yandexCloud() {
	db, err := ydb.Open(
		context.TODO(),
		"grpcs://ydb.serverless.yandexcloud.net:2135/?database=/ru-central1/yc.serverless.cloud/etne6yegf7346f0h71tpev2p",
		yc.WithInternalCA(),
...
func Example_withServiceAccountKeyFileCredentials_nebius() {
	db, err := ydb.Open(
		context.TODO(),
		"grpcs://ydb.serverless.il.nebius.cloud:2135/il1/yc.mds-team.service-cloud/a3duh738rh48homerna57",
